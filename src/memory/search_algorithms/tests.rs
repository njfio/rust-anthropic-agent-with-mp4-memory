...
async fn test_inverted_index_search() {
    ...
    // Add test documents
    index.add_document(create_test_document("1", "hello world")).unwrap();
    index.add_document(create_test_document("2", "world peace")).unwrap();
    index.add_document(create_test_document("3", "hello there")).unwrap();
...
async fn test_inverted_index_tf_idf_scoring() {
    ...
    index.add_document(create_test_document("1", "cat cat dog")).unwrap();
    index.add_document(create_test_document("2", "cat bird")).unwrap();
    index.add_document(create_test_document("3", "dog bird")).unwrap();
...
async fn test_trie_index_prefix_search() {
    ...
    // Add test documents
    index.add_document(create_test_document("1", "hello world")).unwrap();
    index.add_document(create_test_document("2", "help me")).unwrap();
    index.add_document(create_test_document("3", "helicopter")).unwrap();
...
async fn test_ngram_index_search() {
    ...
    // Add test documents
    index.add_document(create_test_document("1", "hello")).unwrap();
    index.add_document(create_test_document("2", "help")).unwrap();
    index.add_document(create_test_document("3", "world")).unwrap();
...
async fn test_vector_index_search() {
    ...
    index.add_document(create_test_document_with_vector("1", "doc1", vec![1.0, 0.0, 0.0])).unwrap();
    index.add_document(create_test_document_with_vector("2", "doc2", vec![0.0, 1.0, 0.0])).unwrap();
    index.add_document(create_test_document_with_vector("3", "doc3", vec![1.0, 1.0, 0.0])).unwrap();
...
async fn test_fuzzy_matcher_search() {
    ...
    // Add test documents
    matcher.add_document(create_test_document("1", "hello")).unwrap();
    matcher.add_document(create_test_document("2", "helo")).unwrap(); // 1 edit distance
    matcher.add_document(create_test_document("3", "help")).unwrap(); // 2 edit distance
    matcher.add_document(create_test_document("4", "world")).unwrap(); // > 2 edit distance
...
async fn test_search_algorithm_enum_equality() {
    ...
    assert_eq!(SearchAlgorithm::InvertedIndex, SearchAlgorithm::InvertedIndex);
