...
mod tests {
    ...
    async fn test_agent_builder() {
        ...
        assert_eq!(
            builder.config.memory.memory_path,
            PathBuf::from("test_memory.json")
        );
    }
    ...
    async fn test_config_defaults() {
        ...
        assert_eq!(
            ...
            PathBuf::from("agent_memory.json")
        );
    ...
    fn test_memory_config_path_handling() {
        ...
        assert_eq!(
            agent_config.memory.memory_path,
            PathBuf::from("custom/path/memory.json")
        );
        assert_eq!(
            agent_config.memory.index_path,
            PathBuf::from("custom/path/memory")
        );
    }
